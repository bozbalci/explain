...
"endi"     return yy::parser::make_ENDI   (loc);
"while"    return yy::parser::make_WHILE  (loc);
"endw"     return yy::parser::make_ENDW   (loc);
"fun"      return yy::parser::make_FUN    (loc);
"endf"     return yy::parser::make_ENDF   (loc);
...
";"        return yy::parser::make_SCOL   (loc);
